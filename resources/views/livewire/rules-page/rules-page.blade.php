            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse" style="background-color: #060e7a" >
                    <ul class="navbar-nav navbar-nav-scroll mx-auto "  >
                        ...
                        <!-- Nav item 2 Pages -->
                        <li class="nav-item dropdown" >
                            <a style="font-size: 9px;background-color: #060e7a;color: #29dbfa" class="nav-link dropdown-toggle " href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">قوانین و مقررات</a>
    ...
    <section class="pt-3 pt-lg-5">
        <div class="container">
            <div class="row">
                <!-- Title -->
                <div class="mb-4">
                    <h2 style="color: #091080;font-weight: bold" class="m-0">{{ $find_id->name_page }}</h2>
                    <hr style="width: 30%">
                    ...
                    <div class="row g-4">
                                        ...
                                        <div class="card border p-3 h-100">
                                            <div class="position-relative">
                                                ...
                                                <a href="shop-detail.html" class="position-relative z-index-9"><img
                                                        class="card-img" src="{{ asset('storage/'.$rule->image_url) }}"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="card-body text-center p-3 px-0">
                                                ...
                                                <h5 class="card-title" style="width: 230px; text-overflow: ellipsis"><a href="#">{{ $rule->title }}</a>
                                                </h5>
                                                <h5 style="font-size: 12px">{{ $rule->submit_date_post }}</h5>
                                                <hr>
                                                <p style="white-space: nowrap; overflow: hidden; width: 100px; text-overflow: ellipsis">{{ $rule->content }}</p>
                                            ...
                                            <div class="card-footer text-center p-0">
                                                <!-- Button -->
                                                <a href="{{ URL::signedRoute('see_details', ['post_id' => $rule->id]) }}"
                        ...
                        @elseif($table_sort == 1)
                            @foreach($sort_rules as $sort_rule)
                                @if($sort_rule->category == $find_id->id)
                                    <!-- Product item START -->
                                    <div class="col-sm-6 col-md-4">
                                        <div class="card border p-3 h-100">
                                            <div class="position-relative">
                                                <!-- Image -->
                                                <a href="shop-detail.html" class="position-relative z-index-9"><img
                                                        class="card-img" src="{{ asset('storage/'.$sort_rule->image_url) }}"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="card-body text-center p-3 px-0">
                                                ...
                                                <h5 class="card-title" style="width: 230px; text-overflow: ellipsis"><a href="#">{{ $sort_rule->title }}</a>
                                                </h5>
                                                <h5 style="font-size: 12px">{{ $sort_rule->submit_date_post }}</h5>
                                                <hr>
                                                <p style="white-space: nowrap; overflow: hidden; width: 100px; text-overflow: ellipsis">{{ $sort_rule->content }}</p>
                                            ...
                                            <div class="card-footer text-center p-0">
                                                <!-- Button -->
                                                <a href="{{ URL::signedRoute('see_details', ['post_id' => $sort_rule->id]) }}"
