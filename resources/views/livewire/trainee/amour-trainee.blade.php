            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse" style="background-color: #060e7a" >
                    <ul class="navbar-nav navbar-nav-scroll mx-auto "  >
                        ...
                        <!-- Nav item 3 Post -->
                        <li class="nav-item dropdown">
                            <a class="nav-link active" style="font-size: 9px;background-color: #060e7a;color: #29dbfa" href="{{ route('amour_trainee') }}">امور کارآموزی</a>
                        </li>
    ...
    <section class="pt-3 pt-lg-5">
        <div class="container">
            <div class="row">
                <!-- Title -->
                <div class="mb-4">
                    <h2 style="color: #091080;font-weight: bold" class="m-0">امور کارآموزی</h2>
                    <hr style="width: 30%">
                    ...
                    <div class="row g-4">
                        ...
                        @if($table_sort == 0)
                            @foreach($posts as $post)
                                @if($post->category == "امور کارآموزان")
                                    <!-- Product item START -->
