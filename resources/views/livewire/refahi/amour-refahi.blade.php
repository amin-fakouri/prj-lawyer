            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse" style="background-color: #060e7a" >
                    <ul class="navbar-nav navbar-nav-scroll mx-auto "  >
                        ...
                        <!-- Nav item 3 Post -->
                        <li class="nav-item dropdown">
                            <a class="nav-link " style="font-size: 9px;background-color: #060e7a;color: #29dbfa" href="{{ route('amour') }}">امور رفاهی </a>
                        </li>
    ...
    <section class="pt-3 pt-lg-5">
        <div class="container">
            <div class="row">
                <!-- Title -->
                <div class="mb-4">
                    <h2 style="color: #091080;font-weight: bold" class="m-0">امور رفاهی</h2>
                    <hr style="width: 30%">
                    ...
                    <div class="row g-4">
                        ...
                        @elseif($table_sort == 1)
                            @foreach($sort_posts as $sort_post)
                                @if($sort_post->category == "امور رفاهی")
                                    <div class="col-sm-6 col-md-4">
                                        <div class="card border p-3 h-100">
                                            <div class="position-relative">
                                                <!-- Image -->
