    ...
    <section class="pt-3 pt-lg-5">
        <div class="container">
            <div class="row">
                <!-- Title -->
                <div class="mb-4">
                    <h2 class="m-0">جستجو وکیل/کارآموز</h2>
                </div>
                    ...
                    <form class="row g-2 g-xl-4 mb-4">
                        ...
                        <div class="col-xl-12">
                            <div class="rounded position-relative">
                                @if($table_sort == 0)
                                    <input class="form-control pe-5" wire:model.live="search" type="search" placeholder="جستجو نام وکیل..." aria-label="Search">
                    ...
                    <div class="row g-4">
                        ...
                        @if($table_sort == 0)
                            @foreach($users as $user)
                                @if($user->role == 'lawyer' or $user->role == "trainee")
                                    <!-- Product item START -->
                                    <div class="col-sm-6 col-md-4">
                                        <div class="card border p-3 h-100">
                                            <div class="position-relative">
                                                <!-- Image -->
                                                <a href="shop-detail.html" class="position-relative z-index-9"><img class="card-img" src="{{ asset('storage/'.$user->image_profile) }}" alt=""></a>
                                            </div>

                                            <!-- Card body -->
                                            <div class="card-body text-center p-3 px-0">
                                                <!-- Title -->
                                                <h5 class="card-title"><a href="#">{{ $user->f_name.','.$user->l_name }}</a></h5>
                                                <hr>
                                                @if($user->role == 'lawyer')
                                                    <h3>وکیل</h3>
                                            ...
                                            <div class="card-footer text-center p-0">
                                                <!-- Button -->
                                                <a href="{{ \Illuminate\Support\Facades\URL::signedRoute('test', ['user_id' => $user->id]) }}"
                                                   class="btn btn-sm btn-primary-soft mb-0"><i class="bi bi-person me-2"></i>دیدن اطلاعات</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Product item END -->
                            ...
                            @endforeach
                        @elseif($table_sort == 1)
                            @foreach($user_sorts as $user_sort)
                                @if($user_sort->role == 'lawyer' and $user_sort->role != null)
                                    <!-- Product item START -->
                                    <div class="col-sm-6 col-md-4">
                                        <div class="card border p-3 h-100">
                                            <div class="position-relative">
                                                <!-- Image -->
                                                <a href="shop-detail.html" class="position-relative z-index-9"><img class="card-img" src="{{ asset('storage/'.$user_sort->image_profile) }}" alt=""></a>
                                            </div>

                                            <!-- Card body -->
                                            <div class="card-body text-center p-3 px-0">
                                                <!-- Title -->
                                                <h5 class="card-title"><a href="#">{{ $user_sort->f_name.','.$user_sort->l_name }}</a></h5>
                                                <hr>
                                                @if($user_sort->role == 'lawyer')
                                                    <h3>وکیل</h3>
                                                @elseif($user_sort->role == 'trainee')
                                                    <h3>کارآموز</h3>
                                                @else
                                            ...
                                            <div class="card-footer text-center p-0">
                                                <!-- Button -->
                                                <a href="{{ \Illuminate\Support\Facades\URL::signedRoute('test', ['user_id' => $user_sort->id]) }}"
                                                   class="btn btn-sm btn-primary-soft mb-0"><i class="bi bi-person me-2"></i>دیدن اطلاعات</a>
                                            </div>
                                        </div>
                                    </div>
