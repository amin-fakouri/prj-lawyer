    ...
    <section>
        <div class="container">
            <div class="row g-4 g-lg-0 justify-content-between">
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <div class="bg-light rounded-2 glightbox-bg p-4 position-relative">
                                <img class="rounded-lg" src="{{ asset('storage/'.$find_user_id->image_profile) }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Title -->
                    <h1 style="color: #070d5d;">{{ 'نام:'.' '.$find_user_id->f_name.' '.$find_user_id->l_name }}</h1>
                    <div class="bg-light p-3 rounded-2 mb-4">
                        <div class="row g-2">
                            ...
                            <div class="col-sm-6">
                                <ul class="list-group list-group-borderless">
                                    <li class="list-group-item py-0">
                                        <span style="color: black"><i class="bi bi-card-text m-2"></i>شماره پروانه وکالت:</span>
                                        <span class="h6 mb-0">{{ $find_user_id->lw_license_number }}</span>
                                    </li>
                                    <li class="list-group-item pb-0">
                                        <span style="color: black"><i class="bi bi-phone-fill m-2"></i>تلفن دفتر کار:</span>
                            ...
                            <div class="col-sm-6">
                                <ul class="list-group list-group-borderless">
                                    <li class="list-group-item py-0">
                                        <span style="color: black"><i class="bi bi-phone-fill m-2"></i>تلفن همراه:</span>
                                        <span id="mobile" class="h6 mb-0">{{ $find_user_id->mobile}}</span>
                                    </li>
                                    <li class="list-group-item pb-0">
                                        <span style="color: black"><i class="bi bi-house m-2"></i>نشانی:</span>
                            ...
                            <div class="col-sm-6">
                                <ul class="list-group list-group-borderless">
                                    <li class="list-group-item py-0">
                                        <span style="color: black"><i class="bi bi-clock-fill m-2"></i>وضعیت اشتغال:</span>
                                        <span class="h6 mb-0">{{ $find_user_id->status_work}}</span>
                                    </li>
                                    <li class="list-group-item pb-0">
                                        <span style="color: black"><i class="bi bi-bank2 m-2"></i>شهر محل اشتغال:</span>
