            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse" style="background-color: #060e7a" >
                    <ul class="navbar-nav navbar-nav-scroll mx-auto "  >
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active" style="font-size: 9px;background-color: #060e7a;color: #29dbfa" href="{{ route('submit_mng') }}" id="postMenu">مصوبات هیات مدیره </a>
                        </li>
                        <!-- Nav item 2 Pages -->
                        <li class="nav-item dropdown" >
    ...
    <section class="pt-3 pt-lg-5">
        <div class="container">
            <div class="row">
                <!-- Title -->
                <div class="mb-4">
                    <h2 style="color: #091080;font-weight: bold" class="m-0">مصوبات هیات مدیره </h2>
                    <hr style="width: 30%">
                    ...
                    <div class="row g-4">
                        ...
                        @if($table_sort == 0)
                            @foreach($posts as $post)
                                @if($post->category == "مصوبات هیات مدیره")
                                    <!-- Product item START -->
                        ...
                        @elseif($table_sort == 1)
                            @foreach($sort_posts as $sort_post)
                                @if($sort_post->category == "امور کارآموزان")
                                    <div class="col-sm-6 col-md-4">
                                        <div class="card border p-3 h-100">
                                            <div class="position-relative">
                                                <!-- Image -->
