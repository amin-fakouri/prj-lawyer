                                ...
                                <div class="rounded position-relative">
                                    @if($table_sort == 0)
                                        <input class="form-control pe-5" wire:model.live="search" type="search"
                                               placeholder="جستجو نام..." aria-label="Search">
                                        <button
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="card border p-3 h-100">
                                                ...
                                                <div class="card-body text-center p-3 px-0">
                                                    ...
                                                    <h5 class="card-title" style="white-space: nowrap; overflow: hidden; width: 220px; text-overflow: ellipsis"><a href="#">{{ $post->full_name }}</a>
                                                    </h5>
                                                    <hr>
                                                    <p style="white-space: nowrap; overflow: hidden; width: 100px; text-overflow: ellipsis">{{ $post->about }}</p>
                                                    <hr>
                                                    <br>
                                                    <!-- Title -->
                                                ...
                                                <div class="card-footer text-center p-0">
                                                    <!-- Button -->
                                                    <a href="{{ URL::signedRoute('person_mng', ['user_id' => $post->id]) }}"
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="card border p-3 h-100">
                                                ...
                                                <div class="card-body text-center p-3 px-0">
                                                    ...
                                                    <h5 class="card-title" style="white-space: nowrap; overflow: hidden; width: 220px; text-overflow: ellipsis"><a href="#">{{ $sort_post->full_name }}</a>
                                                    </h5>
                                                    <hr>
                                                    <p style="white-space: nowrap; overflow: hidden; width: 100px; text-overflow: ellipsis">{{ $sort_post->about }}</p>
                                                    <hr>
                                                    <!-- Title -->
                                                ...
                                                <div class="card-footer text-center p-0">
                                                    <!-- Button -->
                                                    <a href="{{ URL::signedRoute('person_mng', ['user_id' => $sort_post->id]) }}"
                                                       class="btn btn-sm btn-primary-soft mb-0"><i
                                                            class="bi bi-newspaper me-2"></i>دیدن اطلاعات</a>
                                                </div>
                                            </div>
